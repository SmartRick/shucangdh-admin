...
import cn.smartrick.metaverse.common.domain.OrderItemDTO;
...
public class SmartPageUtil {
    ...
    /**
     * 将mybatis分页结果转换为前端呈现分页DTO
     *
     * @param page mybatis的分页对象
     * @return PageResultDTO<T>  业务分页返回对象
     */
    ...
    /**
     * 将业务分页参数转换为mybatis的分页参数
     *
     * @param baseDTO mybatis的分页对象
     * @return PageResultDTO<T>  业务分页返回对象
     */
